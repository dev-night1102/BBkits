import{J as j,r as N,j as e,Q as w}from"./app-CZ-nmFtm.js";import{A as y}from"./AuthenticatedLayout-BilVZ13k.js";import{S as k}from"./SalesModal-CE7fmLdV.js";import{R as F}from"./RankingDisplay-B7r9jufL.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-B5YmGfyL.js";import"./x-DGQl0xiv.js";import"./createLucideIcon-Vt_KReXx.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
