import{J as j,r as N,j as e,Q as w}from"./app-DpgpDZl8.js";import{A as y}from"./AuthenticatedLayout-_fx1UMwq.js";import{S as k}from"./SalesModal-BCBn11Dn.js";import{R as F}from"./RankingDisplay-BO_umMrw.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-B4Lc3RcL.js";import"./x-vLmRXh6s.js";import"./createLucideIcon-C-qQQYt7.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
