import{J as g,r as b,j as e,Q as f}from"./app-Dg5RBoOc.js";import{A as u}from"./AuthenticatedLayout-DWMLAiDo.js";import{S as v}from"./SalesModal-BMtxphef.js";import{R as m}from"./RankingDisplay-BJMRVUWZ.js";import{f as t}from"./currency-Ct0iAvPU.js";import"./transition--pGnQ9xp.js";import"./x-CXZ2bsKr.js";import"./createLucideIcon-5uj7092E.js";function M(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
