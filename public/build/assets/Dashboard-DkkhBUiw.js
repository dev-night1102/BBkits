import{J as j,r as N,j as e,Q as w}from"./app-CizGttYo.js";import{A as y}from"./AuthenticatedLayout-xS3ffn1s.js";import{S as k}from"./SalesModal-CO8Nzpgb.js";import{R as F}from"./RankingDisplay-C4VQhhF6.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-ClvMeK2u.js";import"./x-C95RBJuL.js";import"./createLucideIcon-CphUg47y.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
