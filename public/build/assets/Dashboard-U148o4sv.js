import{J as j,r as N,j as e,Q as w}from"./app-cQ_RaytM.js";import{A as y}from"./AuthenticatedLayout-BLspUDRi.js";import{S as k}from"./SalesModal-CM_nUvNX.js";import{R as F}from"./RankingDisplay-CcFzetqf.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-DH3jhroc.js";import"./x-DZtlJJ0m.js";import"./createLucideIcon-CT1vxiXn.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
