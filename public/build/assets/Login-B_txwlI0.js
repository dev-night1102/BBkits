import{x as g,r as u,V as t,j as e,Q as h,t as l}from"./app-y5HK80UR.js";import"./TextInput-DQf9rOTt.js";function w({status:o,canResetPassword:d}){const{data:n,setData:i,post:m,processing:c,errors:r,reset:x}=g({email:"",password:"",remember:!1});u.useEffect(()=>{o&&t.success(o)},[o]);const p=a=>{a.preventDefault(),m("/login",{onFinish:()=>x("password"),onSuccess:()=>{t.success("Login realizado com sucesso!")},onError:s=>{s.email&&t.error(s.email),s.password&&t.error(s.password)}})};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Entrar - BBKits"}),e.jsx("style",{children:`
