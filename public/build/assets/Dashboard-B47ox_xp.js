import{J as h,r as p,j as e,Q as g}from"./app-BxjLuJw5.js";import{A as b}from"./AuthenticatedLayout-jWFhbNrm.js";import{S as u}from"./SalesModal-CnMdaioj.js";import{R as f}from"./RankingDisplay-CCHSCSYZ.js";/* empty css            */import"./transition-Bc7BRGEh.js";import"./x-Dld28H3c.js";import"./createLucideIcon-DmfGCP4S.js";const s=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function C(){var o;const{auth:l,gamification:r,salesData:t,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:t,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
