import{J as g,r as b,j as e,Q as f}from"./app-BaY2zMMv.js";import{A as u}from"./AuthenticatedLayout-D69C9_Vo.js";import{S as v}from"./SalesModal-Cpi01l6a.js";import{R as m}from"./RankingDisplay-B89zm1nz.js";import{f as t}from"./currency-Ct0iAvPU.js";import"./transition-B4JsMSZQ.js";import"./x-BoIg5PhI.js";import"./createLucideIcon-BoLknLxW.js";function M(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
