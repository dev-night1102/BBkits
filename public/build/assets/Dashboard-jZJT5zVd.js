import{J as h,r as p,j as e,Q as g}from"./app-CC82fK_d.js";import{A as b}from"./AuthenticatedLayout-oRgr-Tet.js";import{S as u}from"./SalesModal-DTw9QUxD.js";import{R as f}from"./RankingDisplay-Reh405-F.js";/* empty css            */import"./transition-pKRvoDci.js";import"./x-d6OZ1SSx.js";import"./createLucideIcon-B0LSRyqo.js";const s=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function C(){var o;const{auth:l,gamification:r,salesData:t,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:t,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
