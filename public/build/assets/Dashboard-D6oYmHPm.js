import{J as g,r as b,j as e,Q as f}from"./app-S6Ljuyvd.js";import{A as u}from"./AuthenticatedLayout-BBgqS-yg.js";import{S as v}from"./SalesModal-BrIX1phj.js";import{R as m}from"./RankingDisplay-Dc3Mx5bn.js";import{f as t}from"./currency-Ct0iAvPU.js";import"./transition-BOmIYvna.js";import"./x-CrIiwuI-.js";import"./createLucideIcon-DP_IksIs.js";function M(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
