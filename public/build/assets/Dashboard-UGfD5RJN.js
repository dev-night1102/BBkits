import{J as N,r as w,j as e,Q as y}from"./app-DosP9ZkK.js";import{A as k}from"./AuthenticatedLayout-lyhasxys.js";import{S as F}from"./SalesModal-C4m-r_rU.js";import{R as _,U as C,T as M}from"./RankingDisplay-BeDzrEt6.js";import{f as r}from"./currency-nnCpYJTe.js";import{c as o}from"./createLucideIcon-Bn62r98g.js";import{D as z,F as B}from"./file-text-BOBYPao0.js";import"./transition-CWgTrbWT.js";import"./x-BFL_eSnG.js";import"./eye-CiKK21U4.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],U=o("plus",I);function Q(){var x;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:b,topPerformers:c}=N().props,[u,m]=w.useState(!1),f=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{m(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:c}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",c),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
