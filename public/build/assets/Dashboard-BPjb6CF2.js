import{J as j,r as N,j as e,Q as w}from"./app-BW1AQr6A.js";import{A as y}from"./AuthenticatedLayout-C1zH6iDp.js";import{S as k}from"./SalesModal-BI8-XQRl.js";import{R as F}from"./RankingDisplay-zXNzNFZZ.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-Ddd13Ww1.js";import"./x-UMRrn6tk.js";import"./createLucideIcon-DDQ7vFS7.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
