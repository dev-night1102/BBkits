import{J as j,r as N,j as e,Q as w}from"./app-CWvITX72.js";import{A as y}from"./AuthenticatedLayout-BgHvDwZc.js";import{S as k}from"./SalesModal-BuUR3UhN.js";import{R as F}from"./RankingDisplay-3PU5LDOe.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-DImfOrRX.js";import"./x-D_jGuTwj.js";import"./createLucideIcon-BuvNYGTI.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
