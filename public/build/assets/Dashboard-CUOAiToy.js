import{J as j,r as N,j as e,Q as w}from"./app-BwmJjTUc.js";import{A as y}from"./AuthenticatedLayout-hsLGx-id.js";import{S as k}from"./SalesModal-kx_OwbYm.js";import{R as F}from"./RankingDisplay-C4B2_3G1.js";import{f as a}from"./currency-nnCpYJTe.js";import"./transition-CzdCYjY9.js";import"./x-BDTDytea.js";import"./createLucideIcon-CEv03IvK.js";function V(){var m;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
